...
public class MapMain {
    ...
    public static void main(String[] args) {
        ...
        Contact defaultContact = new Contact("Satyam Purohit");
        ...
        System.out.println("uodatedDaisy = " + updatedDaisy);
        boolean success = contacts.replace("Daisy Duck", daisy ,updatedDaisy);
        if (success) {
            System.out.println("successfully replaces element");
        } else  {
            System.out.printf("did notmatch on both kay: %s and value: %s %n".formatted("Daisy Duck", replacedContact));
        }
        contacts.forEach((k, v) -> System.out.println("Key=" + k + ", value= " + v));
